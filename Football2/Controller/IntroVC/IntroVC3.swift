...
class IntroVC3: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.topLbl.text = "Catch Football Live, Anytime, Anywhere Now".localized()
        self.bottomLbl.text = "Football excitement, delivered straight to your screen.".localized()
        self.nextLbl.text = "Get Started".localized()
    }
...
extension IntroVC3: OptionControllerDelegate {
