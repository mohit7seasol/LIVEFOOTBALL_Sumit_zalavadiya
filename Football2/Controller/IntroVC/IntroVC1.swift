...
class IntroVC1: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.topLbl.text = "Never Miss a Goal, Watch Live Football".localized()
        self.bottomLbl.text = "From kick-off to final whistle - live updates nonstop.".localized()
    ...
    @IBAction func nextTapped(_ sender: UIButton) {
        NotificationCenter.default.post(name: .step2Next, object: nil)
    }
    
}

extension IntroVC1: OptionControllerDelegate {
